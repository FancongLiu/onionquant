...
def get_series_mapping():
    ...
    mapping = {
        ...
        "AD": (
            choice_doc,
            13,
            "Exact series match: AD15-AD28 Choice Technical Guide covers all AD models. Confirmed via JCI Fluid Topics API.",
        ),
        "AE": (
            choice_doc,
            10,
            "Same product family: Choice product line. AE is Choice sub-series. Doc covers AD15-AD28 product family.",
        ),
        "AK": (
            choice_doc,
            10,
            "Same product family: Choice product line. AK is Choice sub-series. Doc covers AD15-AD28 product family.",
        ),
        "AS": (
            choice_doc,
            10,
            "Same product family: Choice product line. AS is Choice sub-series. Doc covers AD15-AD28 product family.",
        ),
        "HD": (
            choice_doc,
            10,
            "Same product family: Choice product line. HD is Choice sub-series with power exhaust option.",
        ),
        # === SELECT R-410A (27.5-50T) ===
        "JH": (
            select_doc,
            10,
            "Same product family: Select product line. JH is Select gas-heat sub-series. Doc covers JV28-JV50 product family.",
        ),
        "JV": (
            select_doc,
            13,
            "Exact series match: JV28-JV50 Select Technical Guide covers JV models directly.",
        ),
        "JX": (
            select_doc,
            10,
            "Same product family: Select product line. JX is Select sub-series. Doc covers JV28-JV50 product family.",
        ),
        "JY": (
            select_doc,
            10,
            "Same product family: Select product line. JY is Select sub-series. Doc covers JV28-JV50 product family.",
        ),
        # === SELECT R-454B (27.5-50T) — New refrigerant generation ===
        "VH": (
            select_doc,
            4,
            "Select R-454B product. Doc is Select R-410A version. Same product architecture, different refrigerant. R-454B Select docs not yet publicly available (product too new).",
        ),
        "VV": (
            select_doc,
            4,
            "Select R-454B product. Doc is Select R-410A version. Same product architecture, different refrigerant.",
        ),
        "VX": (
            select_doc,
            4,
        ...
        "GVA": (
            premier_25,
            10,
            "Premier 25-80T R-410A Technical Guide from hvacnavigator.com. GVA is Premier sub-series (standard efficiency). Capacity 274000 (~23T) fits 25-80T range.",
        ),
        "GVB": (
            premier_25,
            10,
            "Premier 25-80T R-410A Technical Guide. GVB is Premier sub-series (medium efficiency). Capacity 336000 (~28T) fits 25-80T range.",
        ),
        "GVC": (
            premier_60,
            6,
            "Premier 60-80T R-454B Technical Guide. GVC is Premier sub-series. Capacity 460000 (~38T) near 60T threshold. R-454B doc for R-410A product — refrigerant mismatch minor for reference.",
        ),
        "GVD": (
            premier_90,
            6,
            "Premier 90-150T R-454B Technical Guide. GVD is Premier sub-series. Capacity 570000 (~47.5T). R-454B doc for R-410A product.",
        ),
        "GVF": (
            premier_90,
            6,
            "Premier 90-150T R-454B Technical Guide. GVF is Premier sub-series (high efficiency). Capacity 675000 (~56T). R-454B doc for R-410A product.",
        ),
        # === CORE R-410A (3-12.5T) — Large ===
        "ZLE": (
            core_large_doc,
            6,
            "Core ZX/ZY/ZQ/ZL R-410A Technical Guide. ZLE is Core R-410A sub-series (Legacy). Doc covers Core 3-12.5T product family. Also has Bosch OEM KLE R-454B counterpart.",
        ),
        "ZLG": (
            core_large_doc,
            6,
            "Core ZX/ZY/ZQ/ZL R-410A Technical Guide. ZLG is Core R-410A sub-series. Doc covers Core 3-12.5T product family. Also has Bosch OEM KLG R-454B counterpart.",
        ),
        # === CORE R-410A (3-6T) — Small / "E" variants ===
        "ZXEA": (
            core_large_doc,
            6,
            "Core ZX/ZY/ZQ/ZL R-410A Technical Guide. ZXEA is Core R-410A small packaged unit. Also has Bosch OEM KXEA R-454B counterpart.",
        ),
        "ZXGA": (
            core_large_doc,
            6,
            "Core ZX/ZY/ZQ/ZL R-410A Technical Guide. ZXGA is Core R-410A small unit. Also has Bosch OEM KXGA R-454B counterpart.",
        ),
        "ZYE": (
            core_large_doc,
            6,
            "Core ZX/ZY/ZQ/ZL R-410A Technical Guide. ZYE is Core R-410A unit. Also has Bosch OEM KYE R-454B counterpart.",
        ),
        "ZYEA": (
            core_large_doc,
            6,
            "Core ZX/ZY/ZQ/ZL R-410A Technical Guide. ZYEA is Core R-410A small unit. Also has Bosch OEM KYEA R-454B counterpart.",
        ),
        "ZYG": (
            core_large_doc,
            6,
            "Core ZX/ZY/ZQ/ZL R-410A Technical Guide. ZYG is Core R-410A gas heat unit. Also has Bosch OEM KYG R-454B counterpart.",
        ),
        "ZYGA": (
            core_large_doc,
            6,
            "Core ZX/ZY/ZQ/ZL R-410A Technical Guide. ZYGA is Core R-410A small gas unit. Also has Bosch OEM KYGA R-454B counterpart.",
        ),
        # === CORE R-410A — Small Heat Pump / AC ===
        "XXE": (
            core_small_doc,
            13,
            "Exact series match: XYE/XXE/XQE Core Technical Guide. XXE08-XXE12 directly covered in document.",
        ),
        "XXEA": (
            core_small_doc,
            13,
            "Exact series match: XXEA7 directly listed in XYE/XXE/XQE Core Technical Guide.",
        ),
        "XYE": (
            core_small_doc,
            13,
            "Exact series match: XYE04-XYE09 directly listed in Core Technical Guide title.",
        ),
        "XYEA": (
            core_small_doc,
            13,
            "Exact series match: XYE series directly covered. XYEA is sub-variant of XYE family.",
        ),
        # === PRO R-410A (3-12.5T) ===
        "ZB": (
            pro_zf_doc,
            6,
            "Pro ZF R-410A Technical Guide covers J06ZF-J12ZF. ZB is Pro R-410A sub-series with same product architecture. Also has Bosch OEM KB R-454B counterpart. Installation manual 5808011-JIM-A-0320 covers J06-12ZB specifically.",
        ),
        "ZJ": (
            pro_zf_doc,
            6,
            "Pro ZF R-410A Technical Guide. ZJ is Pro R-410A sub-series with same product architecture. Also has Bosch OEM KJ R-454B counterpart. Installation manuals available for JA3ZJ-JA5ZJ and J06ZJ-J12ZJ.",
        ),
        "ZT": (
            pro_zt_doc,
            10,
            "Pro ZT UHE R-410A Technical Guide covers JA3ZT-J12ZT. ZT is Pro UHE sub-series. Doc covers same product family with correct refrigerant.",
        ),
        "ZE": (
            ze_doc,
            10,
            "ZE Sunline R-410A Technical Guide covers ZE036-ZE072. ZE072 matches manifest ZE072 at 66000 capacity. Sunline/Pro product line.",
        ),
        "XP": (
            pro_xp_doc,
            10,
            "Pro XP Heat Pump R-410A Technical Guide covers J06XP-J12XP. XP is Pro heat pump sub-series. Correct refrigerant.",
        ),
        # === SERIES 20 (15-25T) ===
        "KK": (
            series20_doc,
            4,
            "Series 20 ZJ/ZR/ZF R-410A Technical Guide. KK is Series 20 R-454B (new refrigerant). Same product architecture, different refrigerant. R-454B Series 20 docs not yet publicly available.",
        ),
        "KS": (
            series20_doc,
            4,
            "Series 20 ZJ/ZR/ZF R-410A Technical Guide. KS is Series 20 R-454B (new refrigerant). Same product architecture, different refrigerant.",
        ),
        # === COMMERCIAL SPLITS — No public docs (same as Bosch) ===
        "KC": (
            None,
            0,
            "Commercial split system. Same as Bosch KC — no public technical documentation available for either brand. Requires dealer portal access.",
        ),
        "KD": (
            None,
            0,
            "Commercial split system. Same as Bosch KD — no public technical documentation available.",
        ),
        "KE": (
            None,
            0,
            "Commercial split system. Same as Bosch KE — no public technical documentation available.",
        ),
        "WC": (
            None,
            0,
            "Commercial split system (R-454B). Same as Bosch WC — no public technical documentation available.",
        ),
        "WD": (
            None,
            0,
            "Commercial split system (R-454B). Same as Bosch WD — no public technical documentation available.",
        ),
        "WE": (
            None,
            0,
            "Commercial split system (R-454B). Same as Bosch WE — no public technical documentation available.",
        ),
        # === UNCATEGORIZED ===
        "J": (
            select_doc,
            3,
            "J10PCC/J15PCC models. Unclear product line — might be legacy packaged units or Series 20 predecessors. Low confidence match to Select documentation. Needs human review.",
        ),
    }
    ...
    for series_key, (doc_info, score, evidence) in mapping.items():
        ...
        if score > 0 and doc_info:
            ...
            if score >= 13:
                ...
                entry["verdict"] = (
                    "High confidence — same product family, correct refrigerant"
                )
            elif score >= 6:
                entry["verdict"] = (
                    "Medium confidence — inferred match, same product architecture"
                )
            elif score >= 4:
                entry["verdict"] = (
                    "Low confidence — same product family, different refrigerant generation"
                )
            elif score >= 3:
                entry["verdict"] = (
                    "Low confidence — legacy/approximate match, needs human review"
                )
        elif score == 0:
