...
Usage:
    python onionquant/tools/live_scanner.py              # 单次扫描
    python onionquant/tools/live_scanner.py --watch 60   # 每60分钟自动扫描
    python onionquant/tools/live_scanner.py --alert 5    # 只显示突升>5名的
"""
...
def _get_twitter_scanner():
    from onionquant.tools.twitter_scanner import TwitterScanner
