...
Usage:
    python onionquant/tools/full_scan.py                    # 完整仪表盘
    python onionquant/tools/full_scan.py --ticker MU        # 单票深度分析
    python onionquant/tools/full_scan.py --ai-chain         # AI产业链速查
    python onionquant/tools/full_scan.py --quick            # 快速模式 (热度+市场)
    python onionquant/tools/full_scan.py --save             # 保存快照
"""
...
class FullScanner:
    ...
    def init(self, use_multi_filter: bool = True):
        ...
        try:
            from onionquant.tools.reddit_scanner import RedditScanner
        ...
        try:
            from onionquant.tools.news_scanner import NewsScanner
