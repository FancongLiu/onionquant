...
Route modules extracted to onionquant/api/:
  api/quant.py     — factors, signals, backtest, optimization, strategies
  api/risk.py      — risk limit checks, alerts
  api/dashboard.py — data health, logs, snapshot, wechat
"""
