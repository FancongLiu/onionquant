...
Usage:
    python company/tools/market_heat.py --scan
    python company/tools/market_heat.py --ticker NVDA
    python company/tools/market_heat.py --unusual-volume
    python company/tools/market_heat.py --options-flow
"""
