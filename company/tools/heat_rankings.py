...
Usage:
    python company/tools/heat_rankings.py                        # 全榜显示
    python company/tools/heat_rankings.py --all-filters          # 18 filter 全量聚合
    python company/tools/heat_rankings.py --top 20               # Top 20
    python company/tools/heat_rankings.py --rising 15            # 24h上升榜
    python company/tools/heat_rankings.py --ai-chain             # AI产业链专属
    python company/tools/heat_rankings.py --save-snapshot        # 保存快照
    python company/tools/heat_rankings.py --trend NVDA           # 单只趋势
"""
