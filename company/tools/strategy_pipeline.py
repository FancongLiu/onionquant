...
Usage:
    python company/tools/strategy_pipeline.py                  # 全量运行
    python company/tools/strategy_pipeline.py --ticker SIVEF   # 单票分析
    python company/tools/strategy_pipeline.py --scan-only       # 仅扫描
"""
