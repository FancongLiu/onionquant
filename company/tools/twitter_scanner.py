...
凭据来源: company/tools/HypeFinder/.env (董事长 2026-05-25 注册的 X Free Tier)
...
Usage:
    python company/tools/twitter_scanner.py --ticker NVDA
    python company/tools/twitter_scanner.py --ticker MU --count 50
"""
