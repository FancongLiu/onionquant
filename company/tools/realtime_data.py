...
Usage:
  python company/tools/realtime_data.py --tickers MU,INTC,MRVL
  python company/tools/realtime_data.py --market-status
  python company/tools/realtime_data.py --futures
"""
