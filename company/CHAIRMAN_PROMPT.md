...
14. ✅ 引入 stigmergy-langgraph 替代顺序执行 (2026-06-12: StigmergyScheduler并行批处理knowledge_management+academic_research+extreme_drive, wake_threshold=0.3同tick调度, fallback顺序执行)
